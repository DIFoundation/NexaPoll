...
export const dummyDAOs: DAO[] = [
  ...
  },
  {
    ...
    logo: '/logos/pixelpunks.png',
    category: 'nft',
    members: 8765,
    proposals: 42,
    activeProposals: 1,
    status: 'active',
    tags: ['art', 'collectibles', 'pfp'],
